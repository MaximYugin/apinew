...
from clients.exercises.exercises_schema import GetExercisesQuerySchema, CreateExerciseRequestSchema, \
    UpdateExerciseSchema, GetExerciseResponseSchema, GetExercisesResponseSchema, CreateExerciseResponseSchema, \
...
class ExercisesClient(APIClient):
    ...
    def update_exercise(self, exercise_id: str, request: UpdateExerciseSchema) -> UpdateExerciseResponseSchema:
