...
from clients.exercises.exercises_schema import CreateExerciseRequestSchema, CreateExerciseResponseSchema, \
    GetExercisesQuerySchema, GetExerciseResponseSchema, UpdateExerciseResponseSchema, UpdateExerciseSchema, \
    GetExercisesResponseSchema
from fixtures.courses import CourseFixture, function_course
from fixtures.exercises import exercises_client, function_exercise
...
class TestExercises:
    ...
    def test_get_exercise(self, function_course, function_exercise, exercises_client):
    ...
    def test_get_exercises(self, exercises_client, function_course, function_exercise):
        response = exercises_client.get_exercises_api(
            GetExercisesQuerySchema(course_id=function_exercise.response.exercise.course_id))
        assert_status_code(response.status_code, HTTPStatus.OK)
